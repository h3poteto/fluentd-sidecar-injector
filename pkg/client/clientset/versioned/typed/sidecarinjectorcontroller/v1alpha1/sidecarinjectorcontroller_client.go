...
import (
	...
	"github.com/h3poteto/fluentd-sidecar-injector/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type SamplecontrollerV1alpha1Interface interface {
	RESTClient() rest.Interface
	SidecarInjectorsGetter
}
...
func (c *SamplecontrollerV1alpha1Client) SidecarInjectors(namespace string) SidecarInjectorInterface {
